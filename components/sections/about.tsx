...
// 👇 client-only animation imports (IMPORTANT)
const Reveal = dynamic(() => import("@/components/animations/reveal"), {
  ssr: false,
})
...
const team = [
  {
    ...
    work:
      "Designs and builds all visual components, animations, and interactions across the website.",
  ...
  },
  {
    ...
    work:
      "Handles data flow, integrations, backend logic, and performance-critical systems.",
  ...
  },
  {
    ...
    work:
      "Connects frontend and backend, builds core features, and ensures product reliability.",
  ...
  },
  {
    ...
    work:
      "Defines product vision, user experience, and ensures consistency across the website.",
        ...
        <Reveal>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg text-gray-400">
              ...
              <br />
              Each member plays a specialized role to deliver exceptional
              results.
            </p>
          </div>
        </Reveal>
